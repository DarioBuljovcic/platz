        ...
        <FadeIn>
          ...
          <div className="prose prose-lg text-brown font-light space-y-8">
            <section>
              ...
              <p>
                Pristupom ovom veb-sajtu, prihvatate ove uslove korišćenja u potpunosti. Platz Caffe zadržava pravo da u bilo kom trenutku izmeni sadržaj sajta ili ove uslove bez prethodne najave.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Sav sadržaj na ovom sajtu, uključujući tekst, slike, logotipe i dizajn, vlasništvo je Platz Caffea ili se koristi uz dozvolu. Zabranjeno je kopiranje, distribucija ili bilo koja druga upotreba sadržaja bez pismene saglasnosti.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Trudimo se da sve informacije na sajtu budu tačne i ažurne (poput cena i ponude u meniju), ali ne garantujemo potpunu tačnost u svakom trenutku. Platz Caffe se ne može smatrati odgovornim za bilo kakvu štetu nastalu korišćenjem informacija sa ovog sajta.
              </p>
            </section>
